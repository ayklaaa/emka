    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('orders', 'Количество заказов'), ('spent', 'Потраченная сумма'), ('average', 'Средний чек')], max_length=50, verbose_name='Тип достижения')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('custom_admin', 'Администратор'), ('user', 'Пользователь'), ('guest', 'Гость')], default='user', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reward', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='users', to='users.reward')),
